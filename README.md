...
<img src="https://images.unsplash.com/photo-1556742111-a301076d9d18?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80" width="800" height="auto" />
...
### 4. Clientes sem parceiros ou dependentes são mais propensos ao churn
A presença de parceiros ou dependentes parece criar um vínculo mais forte com os serviços, reduzindo a probabilidade de cancelamento.
...
|----------------------|-----------|--------|----------|---------|
| **XGBoost**          | **47%**   | **83%**| **60%**  | **0.85**|
| Regressão Logística  | 51%       | 79%    | 62%      | 0.84    |
| Random Forest        | 54%       | 70%    | 61%      | 0.83    |
...
Os resultados consistentes entre validação e teste confirmam que o modelo generaliza bem para novos dados.
...
## Conclusão
O projeto demonstrou que é possível identificar proativamente clientes em risco de churn com alta precisão. O modelo XGBoost alcançou **83% de recall**, permitindo à empresa capturar a grande maioria dos clientes que realmente cancelariam seus serviços.
